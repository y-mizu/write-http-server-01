...
public class HTTPResponseTest {
    ...
    public void createContentTypeで与えられたファイル拡張子のcontentTypeを判別する() {
        String fileExt[] = {"html", "css", "js", "jpeg", "png", "gif"};
        String expectedContetnts[] = {"text/html", "text/css", "text/js", "image/jpeg", "image/png", "image/gif"};

        for (int i = 0; i < fileExt.length; i++){

            String file = fileExt[i];

            assertThat(expectedContetnts[i], is(httpResponse.createContentType(file)));
        }
    }
    ...
    public void createReasonPhraseでstatusCodeからreasonPhraseを取得する() {
        ...
        String actual[] = {"OK", "Bad Request", "Not Found", "Internal Sever Error"};
